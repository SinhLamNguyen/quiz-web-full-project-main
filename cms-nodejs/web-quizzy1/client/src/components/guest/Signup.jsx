        ...
        <div className='w-full h-screen flex flex-col bg-[#461A42] overflow-auto'>
            <div className='bg-[#461A42] flex flex-row justify-between shadow-lg py-5 '>
                ...
                <div className='w-full flex flex-row gap-6 mr-3 items-center justify-end'>
                    ...
                    <button onClick={()=>goToLogin()} className=' bg-[#5D2057] py-2 px-4 scale-100 text-white flex items-center justify-center rounded hover:scale-110 transition-transform duration-300'> Log in </button>
                </div>
            </div>
                ...
                <div className='flex flex-row bg-white rounded-md'>
                    <div className='w-[60%] flex flex-col justify-between'>
                        <div className='p-10 flex flex-col'>
                            <p className='font-semibold text-xl text-gray-800'>Welcome to Quizizz</p>
                            <p className='text-base text-gray-500 mb-3'>Create a free account in 2 steps</p>
                            {/* <LoginForm/> */}
                            <SignupForm/>
                        ...
                        <div className='flex flex-col mt-12'>
                            <div className='text-center text-xs text-gray-400 py-4'>
                                By signing up, you agree to our <span className='underline'>Terms of Service</span> & <span className='underline'>Privacy Policy</span> </div>
                            <div className='py-4 bg-gray-50 flex items-center justify-center'>
                                ...
                                <button className='ml-1 flex items-center py-1 px-3 rounded bg-gray-200 text-purple-500 text-xs font-semibold'> Log in </button>
                            </div>
                        </div>
